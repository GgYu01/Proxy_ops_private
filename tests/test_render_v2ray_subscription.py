...
class V2RayRenderTests(unittest.TestCase):
    def test_v2ray_subscription_contains_only_currently_healthy_raw_ip_nodes(self) -> None:
        ...
        self.assertNotIn("QQPW-Residential-SOCKS5", artifact)
        ...
        self.assertNotIn("@38.65.93.39:10007", artifact)
    ...
    def test_vmrack1_and_qqpw_use_distinct_ports(self) -> None:
        ...
        self.assertNotIn("QQPW-Residential-SOCKS5", qqpw)
        self.assertIn("@38.65.93.39:10005", qqpw)
        self.assertIn("@38.65.93.39:10006", qqpw)
        self.assertNotIn("@38.65.93.39:10007", qqpw)
